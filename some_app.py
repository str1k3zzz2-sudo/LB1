...
def index():
    ...
    if form.validate_on_submit():
        try:
            ...
            error = str(e)
    return render_template('index.html', form=form, original_img=orig_url, modulated_img=mod_url, histogram_img=hist_url, error=error)

if __name__ == '__main__':
    app.run(debug=True, host='0.0.0.0', port=5000)
# Web application for image modulation
